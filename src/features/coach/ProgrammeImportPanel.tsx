...
interface ProgrammeImportPanelProps {
...
export function ProgrammeImportPanel({
  onImported,
}: ProgrammeImportPanelProps) {
    ...
    <>
      <section className={styles.importCard}>
        <div className={styles.importHeader}>
          <div>
            <span className={styles.kicker}>NEXT PROGRAMME</span>
            <h2>Import ChatGPT programme JSON</h2>
            <p>
              Upload the programme returned by ChatGPT, validate every exercise ID
              and prescription, then commit the approved block to PROJECT FREAK.
            </p>
          </div>
          <input
            ref={file_input_ref}
